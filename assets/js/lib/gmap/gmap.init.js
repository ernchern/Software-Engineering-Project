...
$(document).ready(function(){
    var mine = new google.maps.LatLng(40.5225631,-112.1386169);

    var pts = [[367,335,'ff3300'], [417,435,'ffcc00'],
        [621,226,'FF0000'],
        [469,749,'FF6600'],
        [430,242,'FF6600'],
        [650,269,'FF6600'],
    ...
    function get_coordinate(y, x) {
        ...
        var a_y_ = 412;
        var a_x_ = 312;
        var y_scale = (a_y - c_y) / (a_y_ - 512);
        var x_scale = (a_x - c_x) / (a_x_ - 512);
        return new google.maps.LatLng((y-512)*y_scale + c_y, (x-512)*x_scale + c_x);
    }
    var pt;
    var image;
    var color;
    ...
    var coordinates;
    for (pt in pts){
        coordinates = get_coordinate(pts[pt][0], pts[pt][1]);
        color = pts[pt][2];
        image = new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|" + color,
